...
export default function Timetable() {
  ...
  const getBlocksForDay = (day: string) => {
    return studyBlocks.filter((block) => block.day === day)
  }
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-3">
                  <Button onClick={addStudyBlock} className="flex-1 bg-gradient-to-r from-green-500 to-emerald-500">
                    Add Block
                  </Button>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-4 rounded-xl bg-gradient-to-r from-blue-500/10 to-cyan-500/10">
                <p className="text-2xl font-bold text-blue-600">{studyBlocks.length}</p>
              ...
              <div className="text-center p-4 rounded-xl bg-gradient-to-r from-green-500/10 to-emerald-500/10">
                <p className="text-2xl font-bold text-green-600">{Math.round(studyBlocks.length * 1.5 * 10) / 10}h</p>
              ...
              <div className="text-center p-4 rounded-xl bg-gradient-to-r from-purple-500/10 to-pink-500/10">
                <p className="text-2xl font-bold text-purple-600">{new Set(studyBlocks.map((b) => b.subject)).size}</p>
